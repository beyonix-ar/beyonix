drop function if exists public.admin_get_client_profiles();

create function public.admin_get_client_profiles()
returns table (
  id uuid,
...
comment on function public.admin_get_client_profiles() is
  'Devuelve al panel administrativo todos los datos cargados de los clientes, incluido el DNI.';
