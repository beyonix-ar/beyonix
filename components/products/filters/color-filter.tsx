        ...
        {availableColors.map((colorKey) => {
          ...
          return (
            <button
              ...
              className={`beyonix-color-swatch relative size-7 rounded-full border shadow-[inset_0_0_0_2px_rgba(255,255,255,0.12)] transition-all duration-200 cursor-pointer ${colorClass} ${
                isSelected
