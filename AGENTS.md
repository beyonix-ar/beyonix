...
- Antes de finalizar cambios, buscar texto con codificación rota como `Ã`, `Â`, `â` o `�`.
- No reemplazar caracteres españoles por versiones sin acento para evitar problemas de codificación.
